...
--SELECT * FROM ordered
--SELECT 'Rgn,DB Name,CPU Cores per Server,CPU Threads per Server,Thread Util % Avg,Thread Util % P90,Thread Util % P95,Thread Util % P99,AAS on CPU Avg,AAS on CPU P90,AAS on CPU P95,AAS on CPU P99,Disk TB per Server,Used TB per Server,Used TB last Month,Current Space Util %,Last Month Space Util %,Disk at 80%,Disk at 90%,Disk at 95%,Disk Config,PDBs,Host Shape,Primary Host Name' AS line
SELECT 'Rgn,DB Name,CPU Cores per Server,CPU Threads per Server,Thread Util % Avg,Thread Util % P90,Thread Util % P95,Thread Util % P99,Disk TB per Server,Used TB per Server,Used TB last Month,Current Space Util %,Last Month Space Util %,Disk at 80%,Disk at 90%,Disk at 95%,Disk Config,PDBs,Host Shape,Primary Host Name' AS line
  FROM DUAL
 UNION ALL
SELECT 
       -- realm_type||','||
