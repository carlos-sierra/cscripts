----------------------------------------------------------------------------------------
--
-- File name:   cs_system_event_hist_latency_char.sql
--
...
--              SQL> @cs_system_event_hist_latency_char.sql
--
...
--
DEF cs_script_name = 'cs_system_event_hist_latency_char';
...
SELECT /*+ MATERIALIZE NO_MERGE */
       ...
       SUM(CASE event_name WHEN '&&event_name_1.' THEN time_waited_ms/total_waits ELSE 0 END) latency_1,
       SUM(CASE event_name WHEN '&&event_name_2.' THEN time_waited_ms/total_waits ELSE 0 END) latency_2,
       SUM(CASE event_name WHEN '&&event_name_3.' THEN time_waited_ms/total_waits ELSE 0 END) latency_3,
       SUM(CASE event_name WHEN '&&event_name_4.' THEN time_waited_ms/total_waits ELSE 0 END) latency_4
