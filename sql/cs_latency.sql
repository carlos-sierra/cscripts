...
SELECT /*+ MATERIALIZE NO_MERGE */
       s.con_id,
       application_category(s.sql_text) type,
       s.delta_elapsed_time/GREATEST(s.delta_execution_count,1)/1e3 et_ms_per_exec,
       s.delta_cpu_time/GREATEST(s.delta_execution_count,1)/1e3 cpu_ms_per_exec,
       s.delta_user_io_wait_time/GREATEST(s.delta_execution_count,1)/1e3 io_ms_per_exec,
       s.delta_application_wait_time/GREATEST(s.delta_execution_count,1)/1e3 appl_ms_per_exec,
       s.delta_concurrency_time/GREATEST(s.delta_execution_count,1)/1e3 conc_ms_per_exec,
       s.delta_execution_count execs,
       s.delta_rows_processed/GREATEST(s.delta_execution_count,1) rows_per_exec,
       s.delta_buffer_gets/GREATEST(s.delta_execution_count,1) gets_per_exec,
       s.delta_disk_reads/GREATEST(s.delta_execution_count,1) reads_per_exec,
