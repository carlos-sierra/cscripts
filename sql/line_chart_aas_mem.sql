...
DEF xaxis_title = "AAS for last &&minutes. minutes";
DEF vaxis_title = "AAS";
...
DEF report_foot_note = "AAS for last &&minutes. minutes";
PRO
SPO line_chart_aas_mem_&&current_time..html;
PRO <html>
...
SELECT sample_id,
 ...
 WHERE sample_time > SYSDATE - (&&minutes. * (1 / 24 / 60))
 GROUP BY
       sample_id,
       sample_time
/* end of query */
