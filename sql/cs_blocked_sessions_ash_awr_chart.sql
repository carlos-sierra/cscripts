----------------------------------------------------------------------------------------
--
-- File name:   cs_blocked_sessions_ash_awr_chart.sql
--
...
--              SQL> @cs_blocked_sessions_ash_awr_chart.sql
--
...
--
DEF cs_script_name = 'cs_blocked_sessions_ash_awr_chart';
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||SUM(CASE q.blocker_session_state WHEN 'ON CPU' THEN q.sessions_blocked ELSE 0 END)|| -- ACTIVE ON CPU
       ','||SUM(CASE q.blocker_session_state WHEN 'WAITING' THEN q.sessions_blocked ELSE 0 END)|| -- ACTIVE WAITING
       ','||SUM(CASE q.blocker_status WHEN 'INACTIVE or UNKNOWN' THEN (CASE q.machine WHEN '&&cs_host_name.' THEN 0 ELSE q.sessions_blocked END) ELSE 0 END)|| -- INACTIVE
       ','||SUM(CASE q.blocker_status WHEN 'INACTIVE or UNKNOWN' THEN (CASE q.machine WHEN '&&cs_host_name.' THEN q.sessions_blocked ELSE 0 END) ELSE 0 END)|| -- UNKNOWN
       ']'
