...
SELECT CASE WHEN '&&p_sql_id.' IS NULL THEN 'SQL' ELSE 'Plans' END top_what FROM DUAL
/
...
SELECT 'top_'||LOWER('&&top_what.')||'_&&locale._&&db_name._'||REPLACE('&&con_name.','$')||(CASE WHEN '&&kiev_tx.' IS NOT NULL THEN TRIM('_&&kiev_tx.') END)||(CASE WHEN '&&sql_text_piece.' IS NOT NULL THEN REPLACE('_&&sql_text_piece.',' ') END)||(CASE WHEN '&&p_sql_id.' IS NOT NULL THEN '_&&p_sql_id.' END)||'_&&snap_id_min._&&snap_id_max.' main_output_file_name FROM DUAL
/

@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "db_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "db_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "cpu_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "cpu_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "io_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "io_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "appl_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "appl_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "conc_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "conc_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "parses_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "executions_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "fetches_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "loads" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "invalidations" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "version_count" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "sharable_mem_mb" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "rows_processed_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "rows_processed_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "buffer_gets_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "buffer_gets_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "disk_reads_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_report_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "disk_reads_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."

HOS zip -m &&main_output_file_name._reports.zip &&main_output_file_name._*.txt

PRO
PRO &&main_output_file_name._reports.zip
PRO
CL COL BRE COMP;
UNDEF 1 2 3 4 5 6;