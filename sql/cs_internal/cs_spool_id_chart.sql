...
PRO &&cs_chart_option_pie. sliceVisibilityThreshold: 1/100, pieHole: 0.4, is3D: false,
...
PRO <pre>
PRO DATE         : &&cs_date_time.Z
PRO REFERENCE    : &&cs_reference.
PRO REGION       : &&cs_region.
PRO LOCALE       : &&cs_locale.
PRO DATABASE     : &&cs_db_name.(&&cs_db_version.) STARTUP:&&cs_startup_time.
