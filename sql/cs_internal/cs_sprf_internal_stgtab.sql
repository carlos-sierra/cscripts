EXEC DBMS_SQLTUNE.create_stgtab_sqlprof(table_name => '&&cs_stgtab_prefix._stgtab_sqlprof', schema_name => '&&cs_stgtab_owner.');
--
...
--
SET LIN 80;
DESC &&cs_stgtab_owner..&&cs_stgtab_prefix._stgtab_sqlprof;
SET LIN 32767;
--
PRO
PRO &&cs_stgtab_owner..&&cs_stgtab_prefix._stgtab_sqlprof;
PRO ~~~~~~~~~~~~~~~~~~~~~~~~~
SELECT COUNT(*) FROM &&cs_stgtab_owner..&&cs_stgtab_prefix._stgtab_sqlprof;
--
