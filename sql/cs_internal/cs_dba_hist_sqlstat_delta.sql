...
SELECT h.snap_id,
       ...
       h.plan_hash_value,
       h.elapsed_time_delta/NULLIF(h.executions_delta, 0)/1e3 avg_et_ms,
       h.cpu_time_delta/NULLIF(h.executions_delta, 0)/1e3 avg_cpu_ms,
       h.iowait_delta/NULLIF(h.executions_delta, 0)/1e3 avg_io_ms,
       h.apwait_delta/NULLIF(h.executions_delta, 0)/1e3 avg_appl_ms,
       h.ccwait_delta/NULLIF(h.executions_delta, 0)/1e3 avg_conc_ms,
       h.buffer_gets_delta/NULLIF(h.executions_delta, 0) avg_bg,
       h.disk_reads_delta/NULLIF(h.executions_delta, 0) avg_disk,
       h.physical_read_bytes_delta/NULLIF(h.executions_delta, 0) avg_read_bytes,
       h.physical_write_bytes_delta/NULLIF(h.executions_delta, 0) avg_write_bytes,
       h.rows_processed_delta/NULLIF(h.executions_delta, 0) avg_row,
       h.executions_delta,
       h.fetches_delta,
       ...
       h.physical_read_bytes_delta delta_physical_read_bytes,
       h.physical_write_bytes_delta delta_physical_write_bytes,
