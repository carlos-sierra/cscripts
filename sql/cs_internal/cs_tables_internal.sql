...
COL total_MiB NEW_V total_MiB FOR 99,999,990.000 HEA 'Total MiB';
COL table_MiB NEW_V table_MiB FOR 99,999,990.000 HEA 'Table MiB';
COL indexes_MiB NEW_V indexes_MiB FOR 99,999,990.000 HEA 'Index(es) MiB';
COL lobs_MiB NEW_V lobs_MiB FOR 99,999,990.000 HEA 'Lob(s) MiB';
COL est_data_MiB FOR 99,999,990.000 HEA 'Est Data MiB';
...
SELECT NULL dummy,
       t.owner,
       t.table_name,
       --(NVL(t.bytes,0)+NVL(i.bytes,0)+NVL(l.bytes,0))/POWER(2,20) total_MiB,
       --NVL(t.bytes,0)/POWER(2,20) table_MiB,
       --NVL(l.bytes,0)/POWER(2,20) lobs_MiB,
       --NVL(i.bytes,0)/POWER(2,20) indexes_MiB,
       ...
       --NVL(d.num_rows*d.avg_row_len,0)/POWER(2,20) est_data_MiB,
