...
DEF report_abstract_2 = "<br>KIEV Transaction:(&&kiev_tx.). (C)=commitTx | (B)=beginTx | (G)=GC | (CB)=commitTx+beginTx | ()=commitTx+beginTx+GC";
...
PRO
SPO dba_hist_sqlstat_kiev_&&current_time..html;
PRO <html>
