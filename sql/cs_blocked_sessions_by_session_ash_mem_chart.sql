----------------------------------------------------------------------------------------
--
-- File name:   cs_blocked_sessions_by_session_ash_mem_chart.sql
--
-- Purpose:     Session Blockers as per ASH from Memory
--
...
--              SQL> @cs_blocked_sessions_by_session_ash_mem_chart.sql
--
...
--
DEF cs_script_name = 'cs_blocked_sessions_by_session_ash_mem_chart';
...
--
PRO ,'&&sid_serial_sql_1.'      
PRO ,'&&sid_serial_sql_2.'      
PRO ,'&&sid_serial_sql_3.'      
PRO ,'&&sid_serial_sql_4.'      
PRO ,'&&sid_serial_sql_5.'      
PRO ,'&&sid_serial_sql_6.'      
PRO ]
--
SET HEA OFF PAGES 0;
/****************************************************************************************/
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||SUM(CASE q.blocker_session_id||','||q.blocker_session_serial#||' '||q.blocker_sql_id WHEN '&&sid_serial_sql_1.' THEN q.sessions_blocked ELSE 0 END)||
       ','||SUM(CASE q.blocker_session_id||','||q.blocker_session_serial#||' '||q.blocker_sql_id WHEN '&&sid_serial_sql_2.' THEN q.sessions_blocked ELSE 0 END)||
       ','||SUM(CASE q.blocker_session_id||','||q.blocker_session_serial#||' '||q.blocker_sql_id WHEN '&&sid_serial_sql_3.' THEN q.sessions_blocked ELSE 0 END)||
       ','||SUM(CASE q.blocker_session_id||','||q.blocker_session_serial#||' '||q.blocker_sql_id WHEN '&&sid_serial_sql_4.' THEN q.sessions_blocked ELSE 0 END)||
       ','||SUM(CASE q.blocker_session_id||','||q.blocker_session_serial#||' '||q.blocker_sql_id WHEN '&&sid_serial_sql_5.' THEN q.sessions_blocked ELSE 0 END)||
       ','||SUM(CASE q.blocker_session_id||','||q.blocker_session_serial#||' '||q.blocker_sql_id WHEN '&&sid_serial_sql_6.' THEN q.sessions_blocked ELSE 0 END)||
       ']'
