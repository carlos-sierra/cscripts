ACC date_time_from PROMPT 'Date and Time FROM (i.e. 2017-08-17T12:39:00): ';
ACC date_time_to PROMPT 'Date and Time TO (i.e. 2017-08-17T12:46:00): ';
...
DEF xaxis_title = "Active Sessions between &&date_time_from. and &&date_time_to.";
...
DEF report_foot_note = "Active Sessions between &&date_time_from. and &&date_time_to..";
PRO
SPO ash_awr_range_cpu_&&sql_id._&&current_time..html;
PRO <html>
...
SELECT sample_id,
 ...
 WHERE sample_time BETWEEN TO_DATE('&&date_time_from.', 'YYYY-MM-DD"T"HH24:MI:SS') AND TO_DATE('&&date_time_to.', 'YYYY-MM-DD"T"HH24:MI:SS')
   AND (sql_id = '&&sql_id.' OR '&&sql_id.' IS NULL)
 GROUP BY
       sample_id,
       sample_time
/* end of query */
