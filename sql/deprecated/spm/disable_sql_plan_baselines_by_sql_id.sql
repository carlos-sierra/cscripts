----------------------------------------------------------------------------------------
--
-- File name:   disable_sql_plan_baselines_by_sql_id.sql
--
-- Purpose:     Disable SQL Plan Baseline for a given SQL_ID
--
...
--              SQL> @disable_sql_plan_baselines_by_sql_id.sql
-- 
--              pass string such as: 
--                d0r59da3g1mbj
--
...
SPO disable_sql_plan_baselines_by_sql_id_&&sql_id._&&x_container._&&current_time..txt;
