...
CASE WHEN 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' LIKE '%5675%' THEN 'X2-2 ' END||
CASE WHEN 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' LIKE '%2690%' THEN 'X3-2 ' END||
CASE WHEN 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' LIKE '%2697%' THEN 'X4-2 ' END||
CASE WHEN 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' LIKE '%2699%' THEN 'X5-2 ' END||
CASE WHEN 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' LIKE '%8870%' THEN 'X3-8 ' END||
CASE WHEN 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' LIKE '%8895%' THEN 'X4-8 or X5-8 ' END||
'with '||cell.cnt||' storage servers'
ELSE 'Unknown' END FROM cell
 UNION ALL
SELECT 'Processor:', 'Intel(R) Xeon(R) CPU           L5335  @ 2.00GHz' FROM DUAL
 UNION ALL
