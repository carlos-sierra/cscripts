...
PRO
DEF report_title = "Average performance of KIEV Tx SQL with a Baseline";
DEF report_abstract_1 = "<br>Average Elapsed Time and CPU Times of SQL statements with a SQL Plan Baseline, and which are part of a KIEV transaction.";
...
PRO
SPO dba_hist_sqlstat_kiev_spm_&&kiev_tx._&&current_time..html;
PRO <html>
...
WITH
all_sql AS (
SELECT DISTINCT con_id, sql_id, sql_text FROM v$sql WHERE sql_plan_baseline IS NOT NULL
--UNION
