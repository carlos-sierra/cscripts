...
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "db_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "db_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "cpu_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "cpu_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "io_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "io_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "appl_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "appl_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "conc_time_aas" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "conc_time_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "parses_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "executions_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "fetches_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "loads" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "invalidations" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "version_count" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "sharable_mem_mb" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "rows_processed_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "rows_processed_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "buffer_gets_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "buffer_gets_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "disk_reads_sec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
@@top_chart_one.sql "&&display_awr_days." "&&snap_id_min." "&&snap_id_max." "disk_reads_exec" "&&kiev_tx." "&&sql_text_piece." "&&p_sql_id."
