----------------------------------------------------------------------------------------
--
-- File name:   cs_snapper_module.sql
--
-- Purpose:     Top Active Sessions for a Module using Tanel Poder Snapper
--
...
DEF cs_module = '&1.';
--
SELECT '&&cs_file_prefix._&&cs_module._&&cs_file_date_time._&&cs_reference_sanitized._&&cs_script_name.' cs_file_name FROM DUAL;
--
