----------------------------------------------------------------------------------------
--
-- File name:   cs_max_ash_awr_chart.sql
--
-- Purpose:     Chart of Max Active Sessions History from AWR
--
...
--
DEF cs_script_name = 'cs_max_ash_awr_chart';
