SET TERM ON HEA OFF LIN 32767 NEWP NONE PAGES 0 FEED OFF ECHO OFF VER OFF LONG 32000 LONGC 2000 WRA ON TRIMS ON TRIM ON TI OFF TIMI OFF ARRAY 100 NUM 20 SQLBL ON BLO . RECSEP OFF;
COL current_time NEW_V current_time FOR A15;
SELECT 'current_time: ' x, TO_CHAR(SYSDATE, 'YYYYMMDD_HH24MISS') current_time FROM DUAL;
PRO SQL_ID &&sql_id.
PRO PLAN_HASH_VALUE &&phv.
SET TERM OFF
PRO
DEF report_title = "Average performance of SQL_ID &&sql_id. &&phv.";
DEF report_abstract_1 = "<br>Average Elapsed Time and CPU Times";
DEF report_abstract_2 = "";
DEF report_abstract_3 = "";
DEF report_abstract_4 = "";
DEF chart_title = "Average performance of SQL_ID &&sql_id. &&phv.";
DEF xaxis_title = "Average Elapsed and CPU Times";
DEF vaxis_title = "Avg Milliseconds per Execution";
...
PRO
SPO dba_hist_sqlstat_&&sql_id._&&current_time..html;
PRO <html>
...
SELECT s.snap_id,
 ...
 WHERE h.executions_delta > 0
   ...
   AND h.sql_id = '&&sql_id.'
   AND h.plan_hash_value = NVL(TO_NUMBER('&&phv.'), h.plan_hash_value)
