----------------------------------------------------------------------------------------
--
-- File name:   cs_cores_and_disk_per_customer_report.sql
--
...
--              SQL> @cs_cores_and_disk_per_customer_report.sql
--
...
--
DEF cs_script_name = 'cs_cores_and_disk_per_customer_report';
--
COL realm FOR A5;
COL rgn FOR A3;
...
--
PRO
PRO 6. Enter ORDER BY: [{NAME}|CPU|DISK]
DEF cs_order_by = '&6.';
UNDEF 6;
...
WHEN 'NAME' THEN 'customer_oci_service, customer_or_pdb'
WHEN 'CPU' THEN 'aas_on_cpu DESC, used_space_gbs DESC, pdbs DESC, cdbs DESC'
WHEN 'DISK' THEN 'used_space_gbs DESC, aas_on_cpu DESC, pdbs DESC, cdbs DESC'
...
/
PRO
PRO 7. Top N Rows Only: [{&&cs_default_top_n_rows.}|1-10000]
DEF cs_top_n_rows = '&7.';
...
PRO SQL> @&&cs_script_name..sql "&&cs_realm." "&&cs_rgn_or_region." "&&cs_locale." "&&cs_dbname." "&&cs_kiev_only." "&&cs_order_by." "&&cs_top_n_rows."
