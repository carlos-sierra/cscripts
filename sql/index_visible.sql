...
BEGIN
  ...
  LOOP
    ...
    DBMS_OUTPUT.PUT_LINE('ALTER INDEX '||i.owner||'.'||i.index_name||' VISIBLE;');
...
SPO OFF;
PRO
PRO Execute make_index_visible.sql
PRO
SPO make_index_visible.txt;
SET ECHO ON TIM ON TIMI ON;
@@make_index_visible.sql
SPO OFF;
PRO
EXIT;
