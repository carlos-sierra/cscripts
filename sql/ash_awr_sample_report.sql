...
SELECT /*+ MATERIALIZE NO_MERGE */
 ...
 WHERE CAST(h.sample_time AS DATE) BETWEEN TO_DATE('&&sample_time.', 'YYYY-MM-DD"T"HH24:MI:SS') - (0.5/24) AND TO_DATE('&&sample_time.', 'YYYY-MM-DD"T"HH24:MI:SS') + (0.5/24) -- +/- 0.5h
 GROUP BY
       h.sample_time,
       h.sql_id,
       h.con_id
