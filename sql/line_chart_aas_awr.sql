...
PRO
DEF report_title = "Average Active Sessions - AAS";
DEF report_abstract_1 = "<br>AAS total, on CPU + resource manager RM, and on CPU.";
DEF report_abstract_2 = "";
DEF report_abstract_3 = "";
DEF report_abstract_4 = "";
DEF chart_title = "Average Active Sessions";
DEF xaxis_title = "AAS for &&date.";
DEF vaxis_title = "AAS";
...
DEF report_foot_note = "AAS for &&date.";
PRO
SPO line_chart_aas_awr_&&current_time..html;
PRO <html>
...
PRO ['Date Column', 'AAS Total', 'AAS on CPU + RM', 'AAS on CPU']
/****************************************************************************************/
WITH   
my_query AS (
...
SELECT sample_id,
 ...
 WHERE sample_time BETWEEN TO_DATE('&&date.', 'YYYY-MM-DD') AND TO_DATE('&&date.', 'YYYY-MM-DD') + 1
 GROUP BY
       sample_id,
       sample_time
/* end of query */
