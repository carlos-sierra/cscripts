...
--
-- Purpose:     Total and Parse DB and CPU Average Active Sessions (AAS) from AWR
--
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||ROUND(q.total_db_secs / q.interval_secs, 3)|| 
       ','||ROUND(q.total_cpu_secs / q.interval_secs, 3)|| 
       ','||ROUND(q.parse_db_secs / q.interval_secs, 3)|| 
       ','||ROUND(q.parse_cpu_secs / q.interval_secs, 3)|| 
       ']'
  FROM my_query q
