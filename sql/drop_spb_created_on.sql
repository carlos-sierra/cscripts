DEF created_from = '2018-05-17T00:00:01';
DEF created_to = '2018-05-25T19:24:20';
...
SELECT /*+ MATERIALIZE NO_MERGE */ 
 ...
 WHERE 1 = 1
   --AND enabled = 'NO'
   AND created BETWEEN TO_DATE('&&created_from.', 'YYYY-MM-DD"T"HH24:MI:SS') AND TO_DATE('&&created_to.', 'YYYY-MM-DD"T"HH24:MI:SS')
),
