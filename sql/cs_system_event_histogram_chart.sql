...
--
-- Purpose:     System Event Histogram Chart
--
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||ROUND(q.b18 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b17 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b16 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b15 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b14 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b13 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b12 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b11 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b10 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b09 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b08 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b07 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b06 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b05 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b04 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b03 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b02 / q.interval_seconds, 3)|| 
       ','||ROUND(q.b01 / q.interval_seconds, 3)|| 
       ']'
  FROM my_query q
