...
CL BRE;
BRE ON pdb_name SKIP PAGE ON con_id ON appl SKIP 1 ON owner ON table_name SKIP 1 ON temporary ON num_rows ON last_analyzed;

SPO death_by_a_thousand_peper_cuts_&&current_time..txt;
PRO HOST: &&x_host_name.
PRO DATABASE: &&x_db_name.
PRO CONTAINER: &&x_container.
PRO
PRO SQL executed over 100,000 times on tables under 1,000 rows
PRO ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
