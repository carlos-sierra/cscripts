-- IOD_SPACE_MAINTENANCE (IOD_REPEATING_SPACE_MAINTENANCE)
...
/
PRO
EXEC c##iod.iod_space.purge_recyclebin (p_preserve_recyclebin_days => '&&preserve_recyclebin_days.', p_timeout => SYSDATE + (&&timeout_hours./24), p_pdb_name => '&&pdb_name.');
PRO
