...
/* $Header: iod_rsrc_mgr.pkb.sql &&library_version. carlos.sierra $
   2019-03-04 rrighett - Fix partition drop
*/
/* ------------------------------------------------------------------------------------ */  
...
BEGIN
  ...
  -- if there is only one partition do nothing
  SELECT count(*)
    INTO l_num_part
