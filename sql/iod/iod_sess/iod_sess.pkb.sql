...
BEGIN
  ...
  -- main cursor
  FOR i IN candidate_sessions (l_lock_secs_thres, l_inac_secs_thres, l_snip_secs_thres, l_snip_idle_profile, l_snip_candidates, l_sniped_sessions, l_tm_locks, l_tx_locks)
  LOOP
