...
COL days_of_history NEW_V days_of_history;
SELECT NVL('&&change_factor.', '10') change_factor, NVL('&&days_of_history.','7') days_of_history FROM DUAL;
...
PRO HISTORY: &&days_of_history. days

PRO
PRO SQL statements for which seconds per execution seems to have changed more than &&change_factor.x during the last &&days_of_history. days.
PRO
...
SPO OFF;
UNDEF change_factor, days_of_history;
CL BREAK;
