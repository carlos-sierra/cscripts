----------------------------------------------------------------------------------------
--
-- File name:   cs_kiev_transactions_list_report.sql.sql
--
-- Purpose:     KIEV Transactions List Report
--
...
--              SQL> @cs_kiev_transactions_list_report.sql.sql
--
...
SELECT NVL(UPPER(TRIM('&&cs2_report.')), 'top') cs2_report FROM DUAL;
...
BEGIN
  SELECT CASE '&&cs2_report.' WHEN 'top' THEN 20 ELSE 10000 END INTO :rows_count FROM DUAL;
END;
/
--
