...
DBMS_REDEFINITION.CAN_REDEF_TABLE(uname=>'&&p_table_owner.', tname=>'&&p_table_name.', options_flag=> dbms_redefinition.cons_use_pk);
DBMS_REDEFINITION.CAN_REDEF_TABLE(uname=>'&&p_table_owner.', tname=>'&&p_table_name.', options_flag=> dbms_redefinition.cons_use_rowid);
prompt
prompt ##########################################################################################################################
