...
--
-- Purpose:     System Event Load Chart from History
--
...
SELECT /*+ MATERIALIZE NO_MERGE */
       ...
       SUM(CASE event_name WHEN '&&event_name_1.' THEN waited_seconds ELSE 0 END) waited_seconds_1,
       SUM(CASE event_name WHEN '&&event_name_2.' THEN waited_seconds ELSE 0 END) waited_seconds_2,
       SUM(CASE event_name WHEN '&&event_name_3.' THEN waited_seconds ELSE 0 END) waited_seconds_3,
       SUM(CASE event_name WHEN '&&event_name_4.' THEN waited_seconds ELSE 0 END) waited_seconds_4
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||ROUND(q.waited_seconds_1 / q.interval_seconds, 3)|| 
       ','||ROUND(q.waited_seconds_2 / q.interval_seconds, 3)|| 
       ','||ROUND(q.waited_seconds_3 / q.interval_seconds, 3)|| 
       ','||ROUND(q.waited_seconds_4 / q.interval_seconds, 3)|| 
       ']'
  FROM my_query q
