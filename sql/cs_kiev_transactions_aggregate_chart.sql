----------------------------------------------------------------------------------------
--
-- File name:   cs_kiev_transactions_aggregate_chart.sql.sql
--
-- Purpose:     KIEV Transactions Aggregare Chart
--
...
--              SQL> @cs_kiev_transactions_aggregate_chart.sql.sql
--
...
SELECT '--' cs2_latency, '//' cs2_latency2, NULL cs2_tps,  NULL cs2_tps2, '--' cs2_count, '//' cs2_coun2, 'Transactions per Second (TPS)' cs2_unit FROM DUAL WHERE '&&cs2_metric.' = 'tps';
...
--
PRO &&cs2_latency2.,'AVG Latency'        
PRO &&cs2_latency2.,'50th PCTL Latency'      
PRO &&cs2_latency2.,'90th PCTL Latency'      
PRO &&cs2_latency2.,'95th PCTL Latency'      
PRO &&cs2_latency2.,'99th PCTL Latency'      
PRO &&cs2_latency2.,'99.9th PCTL Latency'      
PRO &&cs2_latency2.,'MAX Latency'        
PRO &&cs2_tps2.,'Transactions per Second (TPS)'       
PRO &&cs2_count2.,'Transactions Count'        
PRO ]
--
SET HEA OFF PAGES 0;
/****************************************************************************************/
...
SELECT kt.transactionid,
 ...
 WHERE kt.endtime IS NOT NULL
   AND kt.status <> 'IN_FLIGHT'
   AND kt.committransactionid <> -1
...
SELECT ktg.endtime_from,
       ...
       ROUND(ktg.transactions / ((ktg.endtime_to - ktg.endtime_from) * 24 * 3600), 1) AS tps,
       ktg.avg_latency_ms,
...
SELECT ', [new Date('||
       ...
       ')'||
       &&cs2_latency.','||q.avg_latency_ms||
       &&cs2_latency.','||q.pctl_50_latency_ms||
       &&cs2_latency.','||q.pctl_90_latency_ms||
       &&cs2_latency.','||q.pctl_95_latency_ms||
       &&cs2_latency.','||q.pctl_99_latency_ms||
       &&cs2_latency.','||q.pctl_999_latency_ms||
       &&cs2_latency.','||q.max_latency_ms||
       &&cs2_tps.','||q.tps||
       &&cs2_count.','||q.transactions||
       ']'
  FROM kte q
 ORDER BY
       q.endtime_to
