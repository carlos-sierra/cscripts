----------------------------------------------------------------------------------------
--
-- File name:   cs_ash_analytics.sql
--
-- Purpose:     Poor-man's version of ASH Analytics
--
...
--
PRO
PRO 10. Reporting Dimension: [{wait_class}|event|machine|sql_id|plan_hash_value|top_level_sql_id|blocking_session|current_obj#|module|pdb_name]
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||NVL(ROUND(q.db_secs_01 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_02 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_03 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_04 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_05 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_06 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_07 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_08 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_09 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_10 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_11 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_12 / q.interval_secs, 3), 0)|| 
       ','||NVL(ROUND(q.db_secs_13 / q.interval_secs, 3), 0)|| 
       ']'
  FROM my_query q
