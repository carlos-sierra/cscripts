----------------------------------------------------------------------------------------
--
-- File name:   cs_sessions_on_cpu_iod_chart.sql
--
-- Purpose:     Percentiles of Sessions on CPU as per IOD metadata (time series chart)
--
...
--              SQL> @cs_sessions_on_cpu_iod_chart.sql
--
...
--
DEF cs_script_name = 'cs_sessions_on_cpu_iod_chart';
