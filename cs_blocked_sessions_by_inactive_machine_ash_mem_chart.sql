----------------------------------------------------------------------------------------
--
-- File name:   cs_blocked_sessions_by_inactive_machine_ash_mem_chart.sql
--
-- Purpose:     Top Session Blockers by Inactive Machine as per ASH from Memory (time series chart)
--
...
--              SQL> @cs_blocked_sessions_by_inactive_machine_ash_mem_chart.sql
--
...
--
DEF cs_script_name = 'cs_blocked_sessions_by_inactive_machine_ash_mem_chart';
...
--
PRO ,{label:'&&machine_1.', id:'1', type:'number'}
PRO ,{label:'&&machine_2.', id:'2', type:'number'}
PRO ,{label:'&&machine_3.', id:'3', type:'number'}
PRO ,{label:'&&machine_4.', id:'4', type:'number'}
PRO ,{label:'&&machine_5.', id:'5', type:'number'}
PRO ,{label:'&&machine_6.', id:'6', type:'number'}    
PRO ]
--
SET HEA OFF PAGES 0;
/****************************************************************************************/
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||num_format(SUM(CASE q.machine WHEN '&&machine_1.' THEN q.sessions_blocked ELSE 0 END))||
       ','||num_format(SUM(CASE q.machine WHEN '&&machine_2.' THEN q.sessions_blocked ELSE 0 END))||
       ','||num_format(SUM(CASE q.machine WHEN '&&machine_3.' THEN q.sessions_blocked ELSE 0 END))||
       ','||num_format(SUM(CASE q.machine WHEN '&&machine_4.' THEN q.sessions_blocked ELSE 0 END))||
       ','||num_format(SUM(CASE q.machine WHEN '&&machine_5.' THEN q.sessions_blocked ELSE 0 END))||
       ','||num_format(SUM(CASE q.machine WHEN '&&machine_6.' THEN q.sessions_blocked ELSE 0 END))||
       ']'
