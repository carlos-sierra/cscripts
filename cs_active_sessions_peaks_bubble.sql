----------------------------------------------------------------------------------------
--
-- File name:   cs_active_sessions_peaks_bubble.sql
--
-- Purpose:     Duration of Active Sessions in Concurrency contention - Peaks Bubble
--
...
--              SQL> @cs_active_sessions_peaks_bubble.sql
--
...
--
DEF cs_script_name = 'cs_active_sessions_peaks_bubble';
...
PRO , 'Time', 'Max Sessions', '&&dimension.', 'Seconds'
PRO ]
--
SET HEA OFF PAGES 0;
/****************************************************************************************/
