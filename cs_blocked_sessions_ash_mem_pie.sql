----------------------------------------------------------------------------------------
--
-- File name:   cs_blocked_sessions_ash_mem_pie.sql
--
-- Purpose:     Top Session Blockers as per ASH from Memory (summary pie chart)
--
...
--              SQL> @cs_blocked_sessions_ash_mem_pie.sql
--
...
--
DEF cs_script_name = 'cs_blocked_sessions_ash_mem_pie';
