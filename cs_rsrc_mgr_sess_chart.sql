----------------------------------------------------------------------------------------
--
-- File name:   dbrms.sql | cs_rsrc_mgr_sess_chart.sql
--
-- Purpose:     Database Resource Manager (DBRM) Sessions (running, headroom and waiting) Chart 
--
...
--              SQL> @cs_rsrc_mgr_sess_chart.sql
--
...
--
DEF cs_script_name = 'cs_rsrc_mgr_sess_chart';
DEF cs_script_acronym = 'dbrms.sql | ';
--
...
--
DEF report_title = 'Average Active Sessions for "&&cs2_level." between &&cs_sample_time_from. and &&cs_sample_time_to. UTC';
...
DEF chart_foot_note_2 = '<br>2) Running Sessions: AAS on CPU. ';
DEF chart_foot_note_3 = "<br>3) Available Headroom: Potential AAS slots available for sessions on CPU.";
DEF chart_foot_note_4 = "<br>4) Waiting Sessions: AAS wating on Scheduler (Resource Manager throttling.)";
DEF report_foot_note = 'SQL> @&&cs_script_name..sql "&&cs_sample_time_from." "&&cs_sample_time_to." "&&cs2_granularity." "&&cs2_level."';
--
@@cs_internal/&&cs_set_container_to_cdb_root.
--
@@cs_internal/cs_spool_head_chart.sql
--
PRO ,{label:'Running Sessions', id:'01', type:'number'}
PRO ,{label:'Available Headroom', id:'02', type:'number'}
PRO ,{label:'Waiting Sessions', id:'03', type:'number'}
PRO ]
SET HEA OFF PAGES 0;
/****************************************************************************************/
WITH
...
SELECT ', [new Date('||
       ...
       ')'||
       ','||num_format(q.avg_running_sessions, 1)|| 
       ','||num_format(q.headroom_sessions, 1)|| 
       ','||num_format(q.avg_waiting_sessions, 1)|| 
       ']'
  FROM my_query q
 ORDER BY
       q.time
