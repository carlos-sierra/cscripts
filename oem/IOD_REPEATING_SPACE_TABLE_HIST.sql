-- IOD_SPACE_TABLE_HIST (IOD_REPEATING_SPACE_TABLE_HIST) (hourly) ALL
-- Table History - Collector
--
...
WHENEVER SQLERROR EXIT FAILURE;
--
ALTER SESSION SET tracefile_identifier = 'iod_space_table';
...
SELECT '/tmp/iod_space_table_hist_'||LOWER(name)||'_'||LOWER(REPLACE(SUBSTR(host_name, 1 + INSTR(host_name, '.', 1, 2), 30), '.', '_')) zip_file_name FROM v$database, v$instance;
