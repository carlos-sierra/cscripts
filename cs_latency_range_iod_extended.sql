----------------------------------------------------------------------------------------
--
-- File name:   cs_latency_range_iod_extended.sql
--
-- Purpose:     SQL latency for a time range (elapsed time over executions) (IOD) - 1m Granularity - Extended
--
...
--              SQL> @cs_latency_range_iod_extended.sql
--
...
--
DEF cs_script_name = 'cs_latency_range_iod_extended';
...
DEF cs_aas_threshold_load = '0.050';
