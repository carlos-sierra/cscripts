...
SELECT /*+ MATERIALIZE NO_MERGE */
       ...
       SUM(CASE event_name WHEN '&&evnt_nam_1.' THEN waited_seconds ELSE 0 END) waited_seconds_1,
       SUM(CASE event_name WHEN '&&evnt_nam_2.' THEN waited_seconds ELSE 0 END) waited_seconds_2,
       SUM(CASE event_name WHEN '&&evnt_nam_3.' THEN waited_seconds ELSE 0 END) waited_seconds_3,
       SUM(CASE event_name WHEN '&&evnt_nam_4.' THEN waited_seconds ELSE 0 END) waited_seconds_4,
       SUM(CASE event_name WHEN '&&evnt_nam_5.' THEN waited_seconds ELSE 0 END) waited_seconds_5,
       SUM(CASE event_name WHEN '&&evnt_nam_6.' THEN waited_seconds ELSE 0 END) waited_seconds_6
