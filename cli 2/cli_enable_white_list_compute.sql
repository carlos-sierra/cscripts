...
MERGE INTO C##IOD.exceptions_black_list o
 USING (SELECT 'TABLE_REDEFINITION' AS iod_api, 'INSTANCES' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'INSTANCEATTRIBUTES' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'VMIATTACHMENT' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'KIEVSNAPSHOTMETADATA' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'HYPERVISORS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'HOSTS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'BUMPCARD' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'TABLE_REDEFINITION' AS iod_api, 'VOLUMEATTACHMENTS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'INSTANCES' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'INSTANCEATTRIBUTES' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'VMIATTACHMENT' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'KIEVSNAPSHOTMETADATA' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'HYPERVISORS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'HOSTS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'BUMPCARD' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'ONLINE_INDEX_REBUILD' AS iod_api, 'VOLUMEATTACHMENTS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'INSTANCES' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'INSTANCEATTRIBUTES' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'VMIATTACHMENT' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'KIEVSNAPSHOTMETADATA' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'HYPERVISORS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'HOSTS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'BUMPCARD' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
         UNION ALL
        SELECT 'GATHER_TABLE_STATS' AS iod_api, 'VOLUMEATTACHMENTS' AS table_name, 'Reduce hard-parse frequency' AS reference FROM DUAL
        ) i
  ON (o.iod_api = i.iod_api AND o.table_name = i.table_name AND o.reference = i.reference)
WHEN NOT MATCHED THEN
  INSERT (iod_api, table_name, reference)
  VALUES (i.iod_api, i.table_name, i.reference)
/
...
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'INSTANCES');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'INSTANCEATTRIBUTES');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'VMIATTACHMENT');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'KIEVSNAPSHOTMETADATA');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'HYPERVISORS');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'HOSTS');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'BUMPCARD');
EXEC DBMS_STATS.lock_table_stats('&&OWNER.', 'VOLUMEATTACHMENTS');
...
-- @cli/cli_enable_white_list_compute.sql