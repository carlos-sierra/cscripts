...
--
-- iodcli sql_exec -y -t PRIMARY file:/Users/csierra/git/bitbucket.oci.oraclecorp.com/dbeng/oratk/sql/cscripts/cli/cli_tps_redo.sql hcg:HC_DATABASE > cli_tps_redo.2021-02-11.txt
-- cut -b 79- cli_tps_redo.2021-02-11.txt | grep "|" | sort -r | uniq > cli_tps_redo.2021-02-11_ordered.txt
--
