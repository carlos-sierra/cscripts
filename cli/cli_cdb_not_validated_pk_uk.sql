REM cli_cdb_not_validated_pk_uk.sql 2021-04-15
REM CDB list of NOT VALIDATED PK/UK constraints and their columns, including VALIDATED status for NOT NULL constraints on such PK/UK columns
...
--
PRO
PRO NOT VALIDATED PK/UK CONSTRAINTS
PRO ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
--
WITH
cdb_stuff AS (
