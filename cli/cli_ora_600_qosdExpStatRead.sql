...
FROM x$dbgalertext WHERE problem_key = 'ORA 600 [qosdExpStatRead: expcnt mismatch]' ORDER BY originating_timestamp;
--
/*
SELECT problem_key
FROM x$dbgalertext WHERE problem_key LIKE '%ORA%600%'
...
SELECT * FROM x$dbgalertext WHERE problem_key = 'ORA 600 [qosdExpStatRead: expcnt mismatch]' ORDER BY originating_timestamp;
@pr
*/
