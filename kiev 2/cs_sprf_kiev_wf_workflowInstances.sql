----------------------------------------------------------------------------------------
--
-- File name:   cs_sprf_kiev_wf_workflowInstances.sql
--
-- Purpose:     Create SQL Profile for specic KIEV scan (workflowInstances,I_GC_INDEX) on all PDBs
--
...
--              SQL> @cs_sprf_kiev_wf_workflowInstances.sql
--
-- Notes:       Developed and tested on 12.1.0.2 and 19c.
--
---------------------------------------------------------------------------------------
--
DEF sql_decoration = "performScanQuery(workflowInstances,I_GC_INDEX)%(1 = 1)%ASC";
DEF phv_to_pin = "472260233";
DEF implementation_script = "DBPERF-7140_2021-05-14T22.39.26Z_SEA_RGN_IOD99RG_OVERLAY_ORM_WFAAS_cs_sprf_export_IMPLEMENT.sql";
DEF rollback_script = "DBPERF-7140_2021-05-14T22.39.26Z_SEA_RGN_IOD99RG_OVERLAY_ORM_WFAAS_cs_sprf_export_ROLLBACK.sql";
--
...
--
DEF cs_script_name = 'cs_sprf_kiev_wf_workflowInstances';
--
