----------------------------------------------------------------------------------------
--
-- File name:   cs_sprf_kiev_wf_leaseDecorators.sql
--
...
--              SQL> @cs_sprf_kiev_wf_leaseDecorators.sql
--
-- Notes:       Developed and tested on 12.1.0.2 and 19c.
--
---------------------------------------------------------------------------------------
--
DEF sql_decoration = "performScanQuery(leaseDecorators,ae_timestamp_index)%(1 = 1)%ASC";
DEF phv_to_pin = "610059206";
DEF implementation_script = "DBPERF-7120_2021-05-12T12.35.47Z_SEA_RGN_IOD01_COMPARTMENTS_WFAAS_cs_sprf_export_IMPLEMENT.sql";
DEF rollback_script = "DBPERF-7120_2021-05-12T12.35.47Z_SEA_RGN_IOD01_COMPARTMENTS_WFAAS_cs_sprf_export_ROLLBACK.sql";
--
...
--
DEF cs_script_name = 'cs_sprf_kiev_wf_leaseDecorators';
--
