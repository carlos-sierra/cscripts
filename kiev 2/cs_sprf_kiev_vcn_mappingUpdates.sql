----------------------------------------------------------------------------------------
--
-- File name:   cs_sprf_kiev_vcn_mappingUpdates.sql
--
-- Purpose:     Create SQL Profile for specic KIEV scan (leaseDecorators,ae_timestamp_index) on all PDBs
--
...
--              SQL> @cs_sprf_kiev_vcn_mappingUpdates.sql
--
-- Notes:       Developed and tested on 12.1.0.2 and 19c.
--
---------------------------------------------------------------------------------------
--
DEF sql_decoration = "populateBucketGCWorkspace%MAPPING_UPDATES_rgn%ASC";
DEF phv_to_pin = "1172229985";
DEF implementation_script = "DBPERF-7353_2021-09-10T20.44.49Z_OC1_BOM_RGN_KIEV02RG_SERVICEGATEWAYBOM_cs_sprf_export_IMPLEMENT.sql";
DEF rollback_script = "DBPERF-7353_2021-09-10T20.44.49Z_OC1_BOM_RGN_KIEV02RG_SERVICEGATEWAYBOM_cs_sprf_export_ROLLBACK.sql";
--
...
--
DEF cs_script_name = 'cs_sprf_kiev_vcn_mappingUpdates';
--
