PRO
PRO SHARABLE MEMORY between &&cs_begin_date_from. and &&cs_end_date_to. (greater than 1MB)
PRO ~~~~~~~~~~~~~~~
SET TERM OFF;
DEF cs_order_by = 's.sharable_mem DESC NULLS LAST';
...
666666             s.has_patch,
666666             '|' AS sp1,
666666             s.sharable_mem,
666666             s.version_count,
666666             s.executions,
666666             '|' AS sp2,
...
666666  WHERE s.sharable_mem >= POWER(2, 20);
SET TERM ON;
/