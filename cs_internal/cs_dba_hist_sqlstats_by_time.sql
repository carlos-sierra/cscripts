-- cs_dba_hist_sqlstats_by_time.sql: called by cs_planx.sql (deprecated)
...
--
PRO
PRO SQL STATS BY MONTH (dba_hist_sqlstat)
PRO ~~~~~~~~~~~~~~~~~~
...
--
PRO
PRO SQL STATS BY WEEK (dba_hist_sqlstat)
PRO ~~~~~~~~~~~~~~~~~
...
--
PRO
PRO SQL STATS BY DAY (dba_hist_sqlstat)
PRO ~~~~~~~~~~~~~~~~
...
--
PRO
PRO SQL STATS BY HOUR (dba_hist_sqlstat)
PRO ~~~~~~~~~~~~~~~~~
