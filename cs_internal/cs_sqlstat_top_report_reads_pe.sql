PRO
PRO READS between &&cs_begin_date_from. and &&cs_end_date_to. (per execution, greater than 0.1)
PRO ~~~~~
SET TERM OFF;
DEF cs_order_by = 's.disk_reads_pe DESC NULLS LAST, s.buffer_gets_pe DESC NULLS LAST';
...
666666  WHERE s.disk_reads_pe >= 0.1;
SET TERM ON;
/