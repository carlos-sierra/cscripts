PRO
PRO VERSION COUNT between &&cs_begin_date_from. and &&cs_end_date_to. (greater than 1024)
PRO ~~~~~~~~~~~~~
SET TERM OFF;
DEF cs_order_by = 's.version_count DESC NULLS LAST';
...
666666  WHERE s.version_count > 1024;
SET TERM ON;
/